<?php include './includes/top.php' ?>
  ...
  <title>Donations :: Cup With Love Project</title>
...
<img src="/images/wnba_heroes.jpg" width="380" height="276" alt="Receiving a $1000 from the Women's NBA" class="text_wrap" />

<h2>How You Can Help Our Organization</h2>

<p>This organization is a non-profit organization. We rely on communities, companies, and much, much more to provide emotional support to cancer survivors, patients undergoing cancer treatment and those impacted by cancer.</p>

<p>Your donations of time and money will assist us in providing advocacy, mentoring, education on cancer prevention, and raising awareness on cancer-related issues. Through these combined efforts your donation benefits and strengthens all communities.</p>
...
<div class="donation_requests">
  <form action="https://www.paypal.com/cgi-bin/webscr" method="post">
    ...
    <input type="hidden" name="hosted_button_id" value="8435835">
    <p><input type="image" src="/images/donations_paypal.jpg" border="0" name="submit" alt="PayPal - The safer, easier way to pay online!"></p>
  </form>
  <a href="/donations_form.pdf" title="Download and print out the donation form"><img src="/images/donations_form.jpg" width="250" height="205" alt="Download and print out the donation form" /></a>
</div>

<h2>Frequently asked questions</h2>

<dl>
  <dt>How are funds I donate used?</dt>
  <dd>
  ...
  <dd>
    ...
    <ol>
      <li><a href="/donations_form.pdf" title="Download and print out the donation form">Download, print, complete and mail form</a>, or</li>
...
<ul class="columns">
  ...
  <li>Coffee mugs (men)</li>
  <li>Children cups (sippy, cartoon, superhero, etc.)</li>
  <li>Tea bags</li>
  <li>Instant chocolate packets</li>
  <li>Packing popcorn</li>
  <li>Wire ribbon</li>
  <li>Tissue</li>
  <li>Colored straw</li>
  <li>Blank gift cards</li>
  <li>Tiny charms</li>
  <li>Stamps</li>
  <li>Stuff animals (new)</li>
  <li>Story books (new)</li>
</ul>

<p>Unfortunately, we cannot use the following type of items:</p>

<ul>
  <li>Cracked, chipped or stained cups</li>
  <li>Used stuffed animals or kid toys</li>
